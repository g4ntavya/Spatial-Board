...
1. Three panes. Notes you scribbled in AR show up already sorted into folders and
   categories the AI named for you. Zero manual tagging. You did nothing. Nice.
2. Tap a note. Your actual handwriting redraws itself stroke by stroke (it's an SVG
   projected out of the 3D strokes), clean text transcription sitting right below.
...
| Enrich | **Process Lambda** | Projects 3D strokes into a smoothed 2D SVG (Catmull-Rom). **Bedrock Nova Pro** does OCR, content-aware titles, and categories. **Bedrock Titan v2** does 1024-d embeddings. |
